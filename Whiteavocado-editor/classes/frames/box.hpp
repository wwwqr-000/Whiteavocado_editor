...
class box {
    ...
    public:
        ...
        int getLineSize() { return this->lineSize; }
        ...
        point2 getMax() { return this->max_; }
        point2 getMin() { return this->min_; }
