...
class menu : public frameObj, public box {
    ...
    public:
        ...
        menu(point2 min_, point2 max_, point3 boxColor, std::vector<menuItem> items, std::string name, FlexDirection direction, bool visable) : box(min_, max_, 1, boxColor), items(items), name(name), direction(direction), frameObj(), visable(visable) {}
